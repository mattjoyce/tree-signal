...
- Debug mode displays panel metrics (weight and dimensions) under each panel title. Enable with `?debug=true` query parameter or by setting `tree-signal.showDebug` in localStorage.
